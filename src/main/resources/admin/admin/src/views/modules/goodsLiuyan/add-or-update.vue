    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="goodsLiuyanText">
                        <el-input type="textarea"  :readonly="ro.goodsLiuyanText" v-model="ruleForm.goodsLiuyanText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.goodsLiuyanText" label="评价内容" prop="goodsLiuyanText">
                            <span v-html="ruleForm.goodsLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.goodsId = true;//商品
                this.ro.yonghuId = true;//用户
                this.ro.goodsLiuyanText = true;//评价内容
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`goodsLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.goodsLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();

    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12" v-if="sessionTable !='goods' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.goodsPhoto" label="商品封面" prop="goodsPhoto">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.goodsPhoto" label="商品封面" prop="goodsPhoto">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预约时间" prop="goodsOrderTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.goodsOrderTime"
                                type="date"
                                placeholder="预约时间"
                                :disabled="ro.goodsOrderTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.goodsOrderTime" label="预约时间" prop="goodsOrderTime">
                            <span v-html="ruleForm.goodsOrderTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="预约状态" prop="goodsOrderTypes">
                        <el-select v-model="ruleForm.goodsOrderTypes" :disabled="ro.goodsOrderTypes" placeholder="请选择预约状态">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="预约状态" prop="goodsOrderValue">
